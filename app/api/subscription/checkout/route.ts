...
export async function POST(request: NextRequest) {
    try {
        ...
        // Using NEXT_PUBLIC_APP_URL instead of hardcoding
        const baseUrl = process.env.NEXTAUTH_URL || process.env.NEXT_PUBLIC_APP_URL || "https://ideas.rynk.io";
        ...
        const checkout = await polar.checkouts.create({
            ...
            metadata: {
                ...
                tier,
                source: "rynk-ideas" // Track source
            },
        });
